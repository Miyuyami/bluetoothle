...
namespace Plugin.BluetoothLE
{
    public abstract class AbstractAdapter : IAdapter
    {
        ...
        public virtual IEnumerable<IDevice> GetConnectedDevices(Guid[] serviceGuids = null) => throw new NotImplementedException("GetConnectedDevices is not supported on this platform");
